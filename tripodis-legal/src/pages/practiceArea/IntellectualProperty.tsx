        ...
        <div className="lg:w-1/2 flex items-center justify-center p-6 md:p-8 lg:p-12">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-800 leading-relaxed mb-4 text-justify">
              Our intellectual property focus arises from an in-depth knowledge
              and pratical experience in the areas of trademarks, patent and
              designs and copyright. We have a unqiue network of intellectual
              property professionals who are able to deliver cost effective and
              efficient service in the registration of trademarks and patents at
              the registry. Our team equally represents clients in intellectual
              property litigation and ensures regulatory compliance on behalf of
              our clients.
            </p>
          </div>
        </div>
