        ...
        <div className="lg:w-1/2 flex items-center justify-center p-6 md:p-8 lg:p-12">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-800 leading-relaxed mb-4 text-justify">
              Our focus on sports comes with market leading experience with some
              of our industry-defining transactions and cases in the emerging
              Nigerian industry and the world at large at FIFA and the
              international Court of Arbitration for Sports. We have first-hand
              experience with negotiating key industry documents including
              talent purchase, connection, operations and maintenance and other
              agreements. We have developed, ahead of the rest of the market, a
              compliance matrix for players in the emerging sports industry.
            </p>
          </div>
        </div>
      </section>
